...
from utils import timestamp_to_datetime_str, datetime_obj_to_timestamp, create_1to1_coversation_id
...
def test_conversation_id_is_symmetric():
    id1 = create_1to1_coversation_id(1, 2)
    id2 = create_1to1_coversation_id(2, 1)
    assert id1 == id2
